...
import { createProjectStructureGit } from '@/utils/project'
...
async function createCommand() {
    ...
    try {
        ...
        await createProjectStructureGit(git, projectDir, answers.projectType, spinner)
